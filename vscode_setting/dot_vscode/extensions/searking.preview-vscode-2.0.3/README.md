...
A previewer of Markdown, reStructuredText, HTML, Jade, Pug, Mermaid files, Image's URI or CSS properties for Visual Studio Code

# README

An extension to preview Markdown, reStructuredText, HTML, Jade, Pug or Mermaid files, Image's URI or CSS while editing them in VSCode
...
+ If file type is Markdown, reStructuredText, HTML, Jade, Pug or Mermaid
...
+ If file type is other
    - Just click on a 
        ...
        * others as Markdown, reStructuredText, HTML, Jade or Mermaid
            * for reStructuredText, docutils is the first choice, and rst2mdown is plan B.
...
python and docutils are recommended to be installed to Preview reStructuredText to preview the rst more accurately.
