...
class HtmlUtil {
    ...
    static sendPreviewCommand(previewUri, displayColumn) {
        if (textUtil_1.TextUtil.versionCompare(vscode_1.version, "1.23.0") < 0) {
    ...
    static sendPreviewCommand_1_23_0_BELOW(previewUri, displayColumn) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield vscode_1.commands.executeCommand(this.COMMAND_TOGGLE_PREVIEW, previewUri, displayColumn);
            }
            catch (reason) {
                console.warn(reason);
    ...
    static sendPreviewCommand_1_23_0(previewUri, displayColumn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const doc = yield vscode_1.workspace.openTextDocument(previewUri);
                ...
                previewDocumentContentProvider_1.PreviewDocumentContentProvider.getPreviewTitle(doc.fileName), displayColumn, // Editor column to show the new webview panel in.
                {
                ...
                panel.webview.html = HtmlUtil.fixImageSrcLinks(doc.getText());
            }
            catch (reason) {
                console.warn(reason);
                vscode_1.window.showErrorMessage(reason);
    ...
    static fixImageSrcLinks(imageSnippet) {
        ...
        }).replace(new RegExp("((?:src|href)=[\'\"])(.*?)([\'\"])", "gmi"), (subString, p1, p2, p3) => {
            if (p2.indexOf(":") != -1) {
                return subString;
            }
            return [
    ...
    static getExtensionPath_1_23_0(...paths) {
        const onDiskPath = vscode_1.Uri.file(HtmlUtil.getExtensionPath_1_23_0_BELOW(...paths));
...
HtmlUtil.COMMAND_TOGGLE_PREVIEW = "vscode.previewHtml";
