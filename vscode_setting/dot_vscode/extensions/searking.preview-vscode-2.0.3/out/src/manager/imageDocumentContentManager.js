...
class ImageDocumentContentManager {
    ...
    generatePreviewSnippet(editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let targetImageUri = imageUri; //await HtmlUtil.fixImageRedirectUrl(imageUri);
            let head = htmlUtil_1.HtmlUtil.fixImageSrcLinks(htmlUtil_1.HtmlUtil.createLocalSource(htmlUtil_1.SourceType.LINK, "header_fix.css"));
